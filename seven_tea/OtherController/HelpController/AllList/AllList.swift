...
var feedbacktype: [String] = ["飲品建議", "手機APP", "其他"]
var testimage: [String] = ["test0", "test1", "test2"]
var homelist: [String] = ["附近店家", "立即下單", "帳戶資料", "常見問題"]
var feedlist: [String] = ["珍珠", "布丁", "大珍珠", "小珍珠", "沒有珍珠", "透明珍珠", "日本人珍珠"]
var itemlist: [String] = ["七盞烏奶","話梅綠","七盞烏奶","話梅綠","七盞烏奶","話梅綠"]
